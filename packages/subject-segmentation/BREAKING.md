...
On **iOS**, the `processImage`, `isGoogleSubjectSegmentationModuleAvailable`, and `installGoogleSubjectSegmentationModule` methods now throw an error with code `Unimplemented` instead of a generic error message.
