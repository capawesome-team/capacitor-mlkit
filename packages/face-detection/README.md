...
**Attention**: This plugin uses **CocoaPods** by default for iOS dependency management. Experimental **Swift Package Manager (SPM)** support is available via [`google-mlkit-swiftpm`](https://github.com/d-date/google-mlkit-swiftpm).
