...
@CapacitorPlugin(name = "GenAiSummarization")
public class GenAiSummarizationPlugin extends Plugin {

    public static final String TAG = "GenAiSummarization";
    ...
    @Nullable
    private GenAiSummarization implementation;
    ...
    @Override
    public void load() {
        implementation = new GenAiSummarization(this);
    }
    ...
    public void summarize(PluginCall call) {
        try {
            SummarizeOptions options = new SummarizeOptions(call);
            NonEmptyResultCallback<SummarizeResult> callback = new NonEmptyResultCallback<>() {
                @Override
                public void success(@NonNull SummarizeResult result) {
                    resolveCall(call, result);
                }
            ...
            assert implementation != null;
            implementation.summarize(options, callback);
        } catch (Exception exception) {
            rejectCall(call, exception);
        }
    }
